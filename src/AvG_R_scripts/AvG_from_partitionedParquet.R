...
.libPaths(c( "C:/Users/svaca/Documents/R/win-library/4.0", "C:/Program Files/R/R-4.0.3/library", "\\\\krypton/svaca/R/win-library/4.0"))
...
## Add other reports here from AvantGardeDIA_AnalyzeSingleAnalyte()
...
write.table(A$Results_TransitionRefinementTool$Report.Replicate.Values,file=paste0(output_dir,"/Report_GR_Replicate_",Name_Tag,"_",i,".csv"),quote=F,row.names=F,col.names=F,sep=";")
...
write.table(A$Results_ReScore,file=paste0(output_dir,"/Report_GR_ReScore_",Name_Tag,"_",i,".csv"),quote=F,row.names=F,col.names=F,sep=";")
